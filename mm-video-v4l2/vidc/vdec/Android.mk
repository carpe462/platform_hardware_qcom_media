...
libmm-vdec-inc          += $(TOP)/hardware/qcom/media-caf/sm8150/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(TOP)/hardware/qcom/media-caf/sm8150/mm-core/inc
libmm-vdec-inc          += $(TOP)/hardware/qcom/media-caf/sm8150/libplatformconfig
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/adreno
libmm-vdec-inc      	+= $(TOP)/hardware/qcom/media-caf/sm8150/libc2dcolorconvert
libmm-vdec-inc      	+= $(TARGET_OUT_HEADERS)/mm-video/SwVdec
libmm-vdec-inc      	+= $(TARGET_OUT_HEADERS)/mm-video/swvdec
libmm-vdec-inc      	+= $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr/include
libmm-vdec-inc      	+= $(TOP)/hardware/qcom/media-caf/sm8150/libarbitrarybytes/inc

ifeq ($(PLATFORM_SDK_VERSION), 18)  #JB_MR2
libmm-vdec-def += -DANDROID_JELLYBEAN_MR2=1
libmm-vdec-inc += $(TOP)/hardware/qcom/media-caf/sm8150/libstagefrighthw
endif
...
libmm-vdec-inc += $(TOP)/hardware/qcom/media-caf/sm8150/hypv-intercept
endif
# ---------------------------------------------------------------------------------
