...
libmm-venc-inc      += $(TOP)/hardware/qcom/media-caf/sm8150/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += $(TOP)/hardware/qcom/media-caf/sm8150/mm-core/inc
libmm-venc-inc      += $(TOP)/hardware/qcom/media-caf/sm8150/libstagefrighthw
libmm-venc-inc      += $(TOP)/hardware/qcom/media-caf/sm8150/libplatformconfig
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += $(TOP)/hardware/qcom/media-caf/sm8150/libc2dcolorconvert
...
ifeq ($(ENABLE_HYP),true)
libmm-venc-inc      += $(TOP)/hardware/qcom/media-caf/sm8150/hypv-intercept
endif
